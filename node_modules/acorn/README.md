...
When run in a CommonJS (languageDetect.js) or AMD environment, exported values
...
`require("acorn")` in languageDetect.js.
...
function. The loose parser is accessible in languageDetect.js via `require("acorn/dist/acorn_loose")`.
