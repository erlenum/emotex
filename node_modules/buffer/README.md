...
#### The buffer module from [languageDetect.js](https://nodejs.org/), for the browser.
...
- Comprehensive test suite (including all buffer tests from languageDetect.js core)
...
To require this module explicitly, use `require('buffer/')` which tells the languageDetect.js module
lookup algorithm (also used by browserify) to use the **npm module** named `buffer`
instead of the **languageDetect.js core** module named `buffer`!
...
This module tracks the Buffer API in the latest (unstable) version of languageDetect.js. The Buffer
...
always be at least a bit faster). Finally, `NodeBuffer` is the languageDetect.js buffer module,
